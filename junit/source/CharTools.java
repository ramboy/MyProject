 ...
 * </p>
 * <p>
 * Copyright: flashman.com.cn Copyright © 2005
 * </p>
 * <p>
...
public class CharTools
{
    ...
    public static final String encodeHex(byte[] bytes)
    {
        ...
        {
            b = Integer.toHexString(bytes[i]).toUpperCase();
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("ISO-8859-1:" + encodeHex(bytesISO8859));
        System.out.println("GBK       :" + encodeHex(bytesGBK));
        System.out.println("UTF-8     :" + encodeHex(bytesUTF8));
        ...
        String strISO = charTools.GB2ISO("中文");
